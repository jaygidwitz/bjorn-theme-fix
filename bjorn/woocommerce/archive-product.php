...
if ( defined('DEMO_MODE') && isset($_GET['woocommerce_sidebar_position']) ) {
  $bjorn_theme_options['woocommerce_sidebar_position'] = $_GET['woocommerce_sidebar_position'];
}

if(isset($bjorn_theme_options['woocommerce_sidebar_position'])) {
	$page_sidebarposition = $bjorn_theme_options['woocommerce_sidebar_position'];
} else {
		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-item-title-archive">
					...
					<h1><?php if(woocommerce_page_title(false) == '') { echo esc_html('Shop', 'bjorn'); } else { woocommerce_page_title(); } ?></h1>
				</div>
			</div>
		</div>
	</div>
